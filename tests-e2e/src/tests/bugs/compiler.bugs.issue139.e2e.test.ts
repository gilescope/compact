...
describe('[Bugs] [Issue #139] search order issue for include and modules is invalid and unsafe', () => {
    const CONTRACTS_ROOT = buildPathTo('/bugs/issue-139/');

    test('provided example should compile successfully', async () => {
