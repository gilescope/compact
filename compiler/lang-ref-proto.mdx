...
@(nonterminals struct-declaration typed-id)
...
@(nonterminals type-alias-declaration)
...
@(nonterminals pattern pattern-struct-elt)
...
@(nonterminals pragma-form version-expr version-expr0 version-term version-atom)
...
@(nonterminals module-definition)
...
@(nonterminals import-form import-selection import-element import-name import-prefix)
...
@(nonterminals witness-declaration simple-parameter-list typed-id)
...
@(nonterminals ledger-declaration)
...
@(nonterminals constructor-definition pattern-parameter-list typed-pattern)
...
@(nonterminals circuit-definition pattern-parameter-list typed-pattern)
...
@(nonterminals cbinding optionally-typed-pattern pattern-struct-elt)
...
@(nonterminals expr-seq expr expr0 expr1 expr2 expr3 expr4 expr5 expr6 expr7 expr8 expr9 tuple-arg bytes-arg struct-arg term)
...
@(nonterminals fun arrow-parameter-list optionally-typed-pattern pattern pattern-struct-elt return-type)
